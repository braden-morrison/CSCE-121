...
int main() {
  ...
  if (image != nullptr) {
	...
	loadVerticalSeam(image, 1, width, height, verticalSeam); 
	removeVerticalSeam(image, width, height, verticalSeam);
	...
	//cout << energy(image, 0, 4, width, height) << " " << energy(image, 1, 4, width, height) << " " << energy(image, 2, 4, width, height) << endl;
	//cout << energy(image, 0, 5, width, height) << " " << energy(image, 1, 5, width, height) << " " << energy(image, 2, 5, width, height) << endl;
	//loadVerticalSeam(image, 1, width, height, createSeam(height)); 
	//cout << endl;

	
	
	//test for seam coordinates
	
	//test for seam energy
